...
/* ======================================
   ...
   MAINNET NETWORK FILTER IS MANDATORY
====================================== */
...
async function withdrawProjectReward(
  ...
  try{
    ...
    console.error(
      "MAINNET reward withdrawal error:",
      e
    );
...
async function withdrawCapital({
  ...
  try{
    ...
    console.error(
      "MAINNET capital withdrawal error:",
      e
    );
...
console.log(
  "✅ ALBUKHR Mainnet Staking Engine v2 loaded | network:",
  STAKING_NETWORK
);

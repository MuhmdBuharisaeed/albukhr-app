// =======================================
// ALBUKHR MAINNET STAKING ENGINE v2
// Pi Mainnet • Supabase Core
// NETWORK ISOLATED
// =======================================
//
// DEPENDS ON:
...
// - Mainnet ONLY.
// - Every stakes read/write is filtered by network=mainnet.
...
function getStakingSupabaseClient(){
  ...
  console.warn(
    "staking-mainnet: ALBUKHR Supabase Core client not found."
  );
...
function assertMainnetStakingNetwork(){
  ...
  /*
    The file itself is mainnet-only.
  ...
  try{
    ...
    for(
      ...
      if(!updated.data){
        ...
        throw new Error(
          "Reward update affected no mainnet stake"
        );
  ...
  try{
    ...
    for(
      ...
      if(!updated.data){
        ...
        throw new Error(
          "Capital update affected no mainnet stake"
        );
